...
function autenticado(){
	...
	let usuario = minusculas(CONFIGURACAO?.usuario?.email) || ''
	if(!usuario)
		return true

	let limitar = '099097109105108097109101108111064116114116049053046106117115046098114;'
	let autenticado = codificar(usuario.trim())
	if(limitar.includes(autenticado))
		return false
