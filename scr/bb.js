function bb(){
	...
	if(!JANELA.includes(LINK.bb.dominio))
		return
...
function bbConsultar(){
	...
	function consultarProcesso(texto=''){
		...
		if(texto.includes('DepositosJudiciaisBancoDoBrasilConsultaRealizada'))
			return
	...
	function consultarDocumento(texto=''){
		...
		if(!texto.includes('documentoPolo'))
			return
	...
	function consultarContaJudicial(texto=''){
		...
		if(!texto.includes('bbContaJudicial'))
			return
